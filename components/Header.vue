    ...
    <nav class="uk-navbar-container" uk-navbar>
      <div class="uk-navbar-left">
        ...
        <ul class="uk-navbar-nav">
          <li class="uk-active"><router-link tag="a" class="navbar-brand" to="/" exact>Companion Lims</router-link></li>
          <li><router-link tag="a" class="navbar-brand" to="/requests" exact>Requests</router-link></li>
        </ul>
